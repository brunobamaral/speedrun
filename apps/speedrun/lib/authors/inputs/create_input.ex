defmodule Speedrun.Authors.Inputs.Create do
  @moduledoc """
  dados de input para chamar insert_new_author
  """
  use Ecto.Schema
  ...
  defp validate_email_and_confirmation_are_the_same(changeset) do
    ...
    if email == confirmation do
      ...
      add_error(changeset, :email_and_confirmation, "Email e confirmation devem ser os mesmos")
    end
  end
end
